...
const BreweryContainer = () => {
  ...
  const handleVisitedBrewery = (brewery) => {
    setVisitedBreweries([...visitedBreweries, brewery]);
  };
  ...
  return (
    <>
      ...
      <article id="suggest">
        ...
        <BreweryList
          breweries={randomBrewery}
          handleFavouriteBrewery={handleFavouriteBrewery}
          handleVisitedBrewery={handleVisitedBrewery}
        />
      </article>
      ...
      <article className="lists">
        <h1>Favourites 🤍</h1>
        <FavouritesList
          favouriteBreweries={favouriteBreweries}
          handleRemoveFavouriteBrewery={handleRemoveFavouriteBrewery}
        />
      </article>
      <article className="lists">
        <h1>Visited</h1>
        <VisitedList visitedBreweries={visitedBreweries}
        />
      </article>
      <section id="images">
